...
from .ExtractAllFromVASP import GetElementsFromVasp, GetNatomFromVasp
import os
...
class DataSurface : 
    ...
    ##################################################################
    def find_corresponding_nb(self,type : str, system : str, el : str) -> int :
    ...
    def add_entry_el(self, el : str, type : str,e_normalised : float) -> None : 
    ...
    ##################################################################
    def add_entry_bulk(self,bulk : str, energy : float, composition : List[List[str] | List[int]]) -> None : 
    ...
    ##################################################################
    def add_entry_slab(self,slab : str, energy :float, composition : List[List[str] | List[int]]) -> None :
    ...
    ##################################################################
    def compute_surface_slab(self,slab : str, path_slab : str) -> float:
    ...
    ##################################################################
    def compute_ecoh_hf(self,bulk) -> None : 
    ...
    ##################################################################
    def build_bounds(self,slab,bulk,el_removed) -> Dict[str,List[np.ndarray] | List[str]]:
    ...
    ##################################################################
    def compute_parametric_surface_energy(self,slab : str, bulk : str, path_slab : str, el_remove : str, vect_diff_mu : np.ndarray, el_diff_mu : List[str]) -> float :
    ...
    ##################################################################
    def data_points_hyperplane(self, path_to_write : str, slab : str, bulk :str, path_slab : str, el_remove : str) -> np.ndarray : 
...
def ExtractPathSlab(list_name_slab : List[str], convergence_file : str) -> List[str] :
...
def ReadConvergenceFile(object : DataSurface, convergence_file : str) -> DataSurface:
...
def ComputeandWriteParametricSurfaceEnergy(object_surface : DataSurface, path_to_write : str, list_name_slab : List[str], bulk : str, list_path_slab : List[str], el_remove : str) -> None : 
