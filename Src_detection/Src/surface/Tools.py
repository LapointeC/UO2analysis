...
from .DataSurfaceObject import DataSurface

def ReadConvergenceFile(path_convergence_file : str, object : DataSurface) -> DataSurface :
...
def NearestMode(list_mode : List[str], mode : str, nb_poss : int) -> List[str]:
