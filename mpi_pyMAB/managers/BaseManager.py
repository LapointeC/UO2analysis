...
from ..results.BABFGatherer import BABFGatherer

class BaseManager:
    """Base class for BAABF manager
    ...
    """
    def __init__(self,world:MPI.Intracomm,parameters:BABFParser,
                 Worker=BABFWorker,Gatherer=BABFGatherer)->None:
        self.world = world
