...
class SurfaceParser : 
    def __init__(self, path_inputs : os.PathLike[str], 
                 mode : str) -> None : 
        self.parameters = {}
    ...
    def init_params(self) : 
        ...
        self.parameters['ToleranceDescriptors'] = 1e-2
    ...
    def parser_inputs_file(self, path_inputs_xml : os.PathLike[str]) :
        ...
        for xml_param in xml_root.getroot() : 
            ...
            if xml_param.tag == 'hklVectors':
                ...
                for hkl in xml_param : 
                    self.parameters['hklVectors'].append( [ int(el) for el in hkl.text.split() ] )
...
class AseVaspParser : 
    def __init__(self, path_inputs : os.PathLike[str]) -> None : 
        ...
        if os.path.exists(path_inputs) :
            ...
            print('... No .xml file for ASE ...')
            print('... Default paramters will be used ...')
            print()
